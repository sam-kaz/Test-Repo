...
public class CorrectDataTestDeadLockTest {
    ...
    public void atLoadCoursesWithCorrectData() throws Exception {
        frap.loadCourses(getFileAbsolutePath("file3_deadlock/courses.csv"));
    }

    @Test
    public void bLoadPrerequisitesWithCorrectData() throws  Exception{
        frap.loadPrerequisitesData(getFileAbsolutePath("file3_deadlock/prerequisites.csv"));
    }
