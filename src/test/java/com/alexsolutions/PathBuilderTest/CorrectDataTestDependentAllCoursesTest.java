...
public class CorrectDataTestDependentAllCoursesTest {
    ...
    public void atLoadCoursesWithCorrectData() throws Exception {
        frap.loadCourses(getFileAbsolutePath("file4_one_course_dependend_on_all/courses.csv"));
    }

    @Test
    public void bLoadPrerequisitesWithCorrectData() throws  Exception{
        frap.loadPrerequisitesData(getFileAbsolutePath("file4_one_course_dependend_on_all/prerequisites.csv"));
    }
    ...
    public void cGetNoPrerequisite() throws  Exception{
        ...
        ArrayList<Integer> expectedData= new ArrayList<Integer>(){{
            add(1);add(2);add(3);add(4);add(5);add(6);add(7);add(8);add(9);add(10);add(11);
        }};
