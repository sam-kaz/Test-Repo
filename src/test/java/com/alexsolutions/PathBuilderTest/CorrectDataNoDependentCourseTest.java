...
public class CorrectDataNoDependentCourseTest {
    ...
    public void atLoadCoursesWithCorrectData() throws Exception {
        frap.loadCourses(getFileAbsolutePath("file5_no_dependent_course/courses.csv"));
    }

    @Test
    public void bLoadPrerequisitesWithCorrectData() throws  Exception{
        frap.loadPrerequisitesData(getFileAbsolutePath("file5_no_dependent_course/prerequisites.csv"));
    }
